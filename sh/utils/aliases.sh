...
alias nctl-network-reload='sh $NTCL/sh/daemons/reload.sh'
alias nctl-network-reset-logs='sh $NTCL/sh/v/reset_logs.sh'
alias nctl-network-setup='sh $NTCL/sh/network/setup.sh'
alias nctl-network-status='sh $NTCL/sh/daemons/status.sh'
alias nctl-network-teardown='sh $NTCL/sh/network/teardown.sh'
alias nctl-network-up='sh $NTCL/sh/node/up.sh'
